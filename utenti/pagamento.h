...
public:
    ...
    container<Domanda*> cerca_domanda(const string&,const Model&) const;//OK per adesso contiene un container di domande, in utente basic la domanda viene cercata solo negli amici mentre negli account a pagamento nel modello
